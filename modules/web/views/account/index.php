...
StaticService::includeAppJsStatic("/js/web/account/index.js", WebAsset::className());
?>
                    ...
                    <div class="row m-t p-w-m">
                        <div class="form-group">
                            <select name="status" class="form-control inline">
                                ...
                                <?php foreach ($status_mapping as $status => $title):?>
                                <option value="<?=$status;?>"  <?php if($status == $search_conditions['status']):?> selected <?php endif;?>><?=$title;?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
