...
StaticService::includeAppJsStatic('/js/web/book/index.js', WebAsset::className());
?>
                        ...
                        <div class="form-group">
                            <select name="cat_id" class="form-control inline">
                                ...
                                <?php foreach( $cat_mapping as $_cat_info ):?>
                                    <option value="<?=$_cat_info['id'];?>" <?php if( $search_conditions['cat_id']  == $_cat_info['id']):?> selected <?php endif;?> ><?=UtiService::encode( $_cat_info['name'] );?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="form-group">
