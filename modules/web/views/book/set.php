...
StaticService::includeAppJsStatic('/js/web/book/set.js', WebAsset::className());
?>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t">
                ...
                <div class="col-lg-10">
                    <select name="cat_id" class="form-control">
                        ...
                        <?php foreach ($cat_list as $_cat_info): ?>
                            <option value="<?= $_cat_info['id']; ?>" <?php if ($info && $_cat_info['id'] == $info['cat_id']): ?> selected <?php endif; ?> ><?= UtiService::encode($_cat_info['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="请输入图书售价" name="price"
                           value="<?= $info ? $info['price'] : ''; ?>">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
