...
<div class="row m-t">
            <div class="col-lg-9 col-lg-offset-2 m-t">
                <dl class="dl-horizontal">
                    <dt>品牌名称</dt>
                    <dd><?=$info?UtiService::encode($info['name']):""?></dd>
                    <dt>品牌Logo</dt>
                    <dd>
                    ...
                    <dt>联系电话</dt>
                    <dd><?=$info?UtiService::encode($info['mobile']):""?></dd>
                    <dt>地址</dt>
                    <dd><?=$info?UtiService::encode($info['address']):""?></dd>
                    <dt>品牌介绍</dt>
                    <dd><?=$info?UtiService::encode($info['description']):""?></dd>
                    <dd>
