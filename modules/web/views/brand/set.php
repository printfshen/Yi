...
StaticService::includeAppJsStatic("/js/web/brand/set.js", WebAsset::className());
?>
            ...
            <div class="col-lg-12">
                ...
                <div class="form-horizontal m-t m-b">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="name" class="form-control" placeholder="请输入品牌名称~~" value="<?=$info['name']?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="mobile" class="form-control" placeholder="请输入联系电话~~"  value="<?=$info['mobile']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="address" class="form-control" placeholder="请输入联系地址~~"  value="<?=$info['address']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
...
<iframe class="hidden" name="upload_file">
